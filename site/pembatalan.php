                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $row["alasan"]; ?></td>
                                            <td>
                        						<a href="hpspesawat.php?id=<?= $row['id_penumpang']; ?>" onclick="return confirm ('Apakah Anda yakin akan ACC pembatalan Tiket?')" class="btn btn-success btn-sm">ACC Pembatalan</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <tbody>
