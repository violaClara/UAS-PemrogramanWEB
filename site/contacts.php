  ...
  <body>
    ...
    <!-- Page-->
      ...
      <header class="section page-header breadcrumbs-custom-wrap bg-gradient bg-secondary-2 novi-background bg-cover">
        ...
        <!-- Breadcrumbs-->
        <section class="breadcrumbs-custom" style="background: url(&quot;images/tujuan/contac.jpg&quot;); background-size: cover;">
          <div class="container">
            <p class="breadcrumbs-custom-subtitle">Hubungi Kami</p>
            <p class="heading-1 breadcrumbs-custom-title">Kontak</p>
          ...
          <div class="row row-fix row-50 row-custom-bordered">
            <div class="col-sm-6 col-lg-3">
              ...
              <article class="box-simple">
                ...
                <h6>Alamat</h6>
                <div class="box-simple-text"><a href="#">Jl. Jend. Ahmad Yani 200A Pabelan, Kartasura, Sukoharjo 57100</a></div>
              </article>
            </div>
            <div class="col-sm-6 col-lg-3">
              <!-- Box simple-->
            ...
            <div class="col-sm-6 col-lg-3">
              ...
              <article class="box-simple">
                ...
                <div class="box-simple-text">
                  <ul class="list-comma list-0">
                    <li><a href="mailto:#">traveloke@gmail.com</a></li>
                  </ul>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-lg-3">
              ...
              <article class="box-simple">
                ...
                <div class="box-simple-text">
                  <ul class="list-0">
                    <li>Senin–Jumat: 9:00 – 18:00 WIB</li>
                    <li>Sabtu–Minggu: 11:00 – 16:00 WIB</li>
                  </ul>
                </div>
              </article>
            </div>
      ...
      <section class="section section-wrap bg-gray-lighter novi-background bg-cover">
        <div class="section-wrap-inner">
            ...
            <div class="row row-fix row-50">
              <div class="col-lg-8 col-xl-7">
                <div class="section-wrap-content section-lg">
                  ...
                  <p class="big">Anda dapat menghubungi kami dengan cara apa pun yang nyaman bagi Anda. Kami tersedia 24/7 melalui faks atau email. Anda juga dapat menggunakan formulir kontak cepat di bawah ini atau mengunjungi kantor kami secara langsung.</p>
                  <!-- RD Mailform-->
                  <form action="mailto:bagasriyan9@gmail.com" method="post" enctype="text/plain">
          ...
          <div class="section-wrap-aside">
            <!-- RD Google Map-->
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3955.1457474647627!2d110.7712382141965!3d-7.559083076740856!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a1445a5525b4d%3A0xa86ead91430e650a!2sJl.%20A.%20Yani%20No.200%2C%20Dusun%20II%2C%20Makamhaji%2C%20Kec.%20Kartasura%2C%20Kabupaten%20Sukoharjo%2C%20Jawa%20Tengah%2057161!5e0!3m2!1sid!2sid!4v1671578207172!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
        </div>
      </section>
