              ...
              <div class="rd-navbar-top-panel-inner">
                <ul class="list-inline">
                  <li class="box-inline list-inline-item"><span class="icon novi-icon icon-md-smaller icon-secondary mdi mdi-phone"></span>
                    <ul class="list-comma">
                      <li><a href="tel:#">(0271)759040</a></li>
                    </ul>
                  </li>
                  <li class="box-inline list-inline-item"><span class="icon novi-icon icon-md-smaller icon-secondary mdi mdi-map-marker"></span><a href="#">Jl. Jend. Ahmad Yani 200A Pabelan, Kartasura, Sukoharjo 57100</a></li>
                  <li class="box-inline list-inline-item"><span class="icon novi-icon icon-md-smaller icon-secondary mdi mdi-email"></span><a href="mailto:#">traveloke@gmail.com</a></li>
                </ul>
                <ul class="list-inline">
        ...
        <div class="swiper-form-wrap">
          ...
          <div class="swiper-container swiper-slider swiper-slider_height-1 swiper-align-left swiper-align-left-custom context-dark bg-gray-darker" data-loop="false" data-autoplay="5500" data-simulate-touch="false" data-slide-effect="fade">
            <div class="swiper-wrapper">
              <div class="swiper-slide" data-slide-bg="images/negara/pantai.jpg">
            ...
            <div class="col-md-6 col-xl-4">
              <article class="event-default-wrap">
                <div class="event-default">
                  <!-- FOTO PERANCIS -->
                  <figure class="event-default-image"><img src="images/negara/perancis.jpg" alt="" width="570" height="370"/>
                  </figure>
                  <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="https://id.wikipedia.org/wiki/Paris" target="_blank">learn more</a></div>
                </div>
                <div class="event-default-inner">
                  <h5><a class="event-default-title" href="https://goo.gl/maps/Wahr9XGPmSi2iaNv8" target="_blank">France, Paris</a></h5><span class="heading-5">from $280</span>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-xl-4">
              <article class="event-default-wrap">
                <div class="event-default">
                  <!-- FOTO AMERIKA -->
                    <figure class="event-default-image"><img src="images/negara/usa.jpg" alt="" width="570" height="370"/>
                  </figure>
                  <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="https://en.wikipedia.org/wiki/United_States" target="_blank">learn more</a></div>
                </div>
                <div class="event-default-inner">
                  <h5><a class="event-default-title" href="https://goo.gl/maps/e7brU99kmwpmbdQq7" target="_blank">USA, Boston</a></h5><span class="heading-5">from $480</span>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-xl-4">
              <article class="event-default-wrap">
                <div class="event-default">
                  <!-- FOTO ITALIA -->
                  <figure class="event-default-image"><img src="images/negara/italia.jpg" alt="" width="570" height="370"/>
                  </figure>
                  <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="https://en.wikipedia.org/wiki/Italy" target="_blank">learn more</a></div>
                </div>
                <div class="event-default-inner">
                  <h5><a class="event-default-title" href="https://goo.gl/maps/svrfMdxZbbACryXa9" target="_blank">Italy, Venice</a></h5><span class="heading-5">from $350</span>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-xl-4">
              <article class="event-default-wrap">
                <div class="event-default">
                  <!-- FOTO INGGRIS -->
                  <figure class="event-default-image"><img src="images/negara/inggris.jpg" alt="" width="570" height="370"/>
                  </figure>
                  <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="https://en.wikipedia.org/wiki/United_Kingdom" target="_blank">learn more</a></div>
                </div>
                <div class="event-default-inner">
                  <h5><a class="event-default-title" href="https://goo.gl/maps/v6HUDChLQoMsQnM9A" target="_blank">UK, London</a></h5><span class="heading-5">from $350</span>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-xl-4">
              <article class="event-default-wrap">
                <div class="event-default">
                  <!-- FOTO DUBAI -->
                  <figure class="event-default-image"><img src="images/negara/dubai.jpg" alt="" width="570" height="370"/>
                  </figure>
                  <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="https://id.wikipedia.org/wiki/Uni_Emirat_Arab" target="_blank">learn more</a></div>
                </div>
                <div class="event-default-inner">
                  <h5><a class="event-default-title" href="https://goo.gl/maps/3yegmxHGrFUfGPSU7" target="_blank">UEA,  Dubai</a></h5><span class="heading-5">from $520</span>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-xl-4">
              <article class="event-default-wrap">
                <div class="event-default">
                  <!-- FOTO SINGAPORE -->
                  <figure class="event-default-image"><img src="images/negara/singapore.jpg" alt="" width="570" height="370"/>
                  </figure>
                  <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="https://id.wikipedia.org/wiki/Singapura" target="_blank">learn more</a></div>
                </div>
                <div class="event-default-inner">
                  <h5><a class="event-default-title" href="https://goo.gl/maps/Fc3hW1Q1x9jLsHms8" target="_blank">Singapura, Singapore</a></h5><span class="heading-5">from $600</span>
                </div>
              </article>
            </div>
          </div>
              ...
              <div class="owl-carousel owl-carousel-team owl-carousel-inset" data-items="1" data-md-items="2" data-xl-items="3" data-stage-padding="15" data-loop="true" data-margin="30" data-mouse-drag="false" data-dots="true" data-autoplay="true">
                <article class="post-blog"><a class="post-blog-image" href="#"><img src="images/negara/hotel.jpg" alt="" width="570" height="415"/></a>
                  <div class="post-blog-caption">
                    ...
                    <div class="post-blog-caption-body">
                      <h5><a class="post-blog-title" href="#">Top 5 Best Hotels in the World</a></h5>
                    </div>
                ...
                <article class="post-blog"><a class="post-blog-image" href="#"><img src="images/negara/plan.jpg" alt="" width="570" height="415"/></a>
                  <div class="post-blog-caption">
                    ...
                    <div class="post-blog-caption-body">
                      <h5><a class="post-blog-title" href="#">Tips on How to Plan a Good Vacation</a></h5>
                    </div>
                    <div class="post-blog-caption-footer">
                      <time datetime="2019">Feb 27, 2019 at 6:53 pm</time><a class="post-comment" href="#"><span class="icon novi-icon icon-md-middle icon-gray-1 mdi mdi-comment"></span><span>12</span></a>
                    </div>
                ...
                <article class="post-blog"><a class="post-blog-image" href="#"><img src="images/negara/asia.jpg" alt="" width="570" height="415"/></a>
                  <div class="post-blog-caption">
                    ...
                    <div class="post-blog-caption-body">
                      <h5><a class="post-blog-title" href="#">Top 5 Asian Countries With Low Cost</a></h5>
                    </div>
                    <div class="post-blog-caption-footer">
                      <time datetime="2019">Feb 27, 2019 at 6:53 pm</time><a class="post-comment" href="#"><span class="icon novi-icon icon-md-middle icon-gray-1 mdi mdi-comment"></span><span>12</span></a>
                    </div>
            ...
            <article class="quote-boxed">
              ...
              <div class="quote-boxed-main">
                ...
                <div class="quote-boxed-meta">
                  <p class="quote-boxed-cite">Astrid Nadia Alimah</p>
                  <p class="quote-boxed-small">K3521013</p>
                </div>
              </div>
            </article>
            <article class="quote-boxed">
              <div class="quote-boxed-aside"><img class="quote-boxed-image" src="images/anggota/agung.jpg" alt="" width="210" height="210"/>
              </div>
              <div class="quote-boxed-main">
                <div class="quote-boxed-text">
                ...
                <div class="quote-boxed-meta">
                  <p class="quote-boxed-cite">Muhammad Agung Nugroho</p>
                  <p class="quote-boxed-small">K3521049</p>
                </div>
              </div>
            </article>
            <article class="quote-boxed">
              ...
              <div class="quote-boxed-main">
                ...
                <div class="quote-boxed-meta">
                  <p class="quote-boxed-cite">Riyan Bagas Dwi Prasetyo</p>
                  <p class="quote-boxed-small">K3521063</p>
                </div>
              </div>
            </article>
            <article class="quote-boxed">
              <div class="quote-boxed-aside"><img class="quote-boxed-image" src="images/anggota/viola.jpg" alt="" width="210" height="210"/>
              </div>
              <div class="quote-boxed-main">
                <div class="quote-boxed-text">
                  <p>Just wanted to say many, many thanks for helping me set up an amazing Costa Rican adventure! My nephew and I had a blast! All of the accommodations were perfect as were the activities that we did (canopy, coffee tour, hikes, fishing, and massages!) We have such fond memories and can't thank you enough!</p>
                ...
                <div class="quote-boxed-meta">
                  <p class="quote-boxed-cite">Viola Clara Citra Pramesti</p>
                  <p class="quote-boxed-small">K3521067</p>
                </div>
              </div>
            </article>
            <article class="quote-boxed">
              <div class="quote-boxed-aside"><img class="quote-boxed-image" src="images/anggota/zidna.jpg" alt="" width="210" height="210"/>
              </div>
              <div class="quote-boxed-main">
                <div class="quote-boxed-text">
                  <p>Just wanted to say many, many thanks for helping me set up an amazing Costa Rican adventure! My nephew and I had a blast! All of the accommodations were perfect as were the activities that we did (canopy, coffee tour, hikes, fishing, and massages!) We have such fond memories and can't thank you enough!</p>
                ...
                <div class="quote-boxed-meta">
                  <p class="quote-boxed-cite">Zidna Fatha Nazhifa</p>
                  <p class="quote-boxed-small">K3521071</p>
                </div>
              </div>
            </article>
          </div>
      ...
      <footer class="section page-footer page-footer-minimal novi-background bg-cover text-center bg-gray-darker">
        <div class="container container-wide">
          <div class="row row-fix justify-content-sm-center align-items-md-center row-30">
            <div class="col-md-10 col-lg-7 col-xl-4 text-xl-left"><a href="index.html"><img class="inverse-logo" src="images/logo/Traveloke.png" alt="" width="208" height="46"/></a></div>
            <div class="col-md-10 col-lg-7 col-xl-4">
              <p class="right"></span> @Pendidikan Teknik Informatika dan Komputer 2021</p>
            </div>
